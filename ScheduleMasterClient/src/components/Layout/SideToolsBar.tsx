...
export default function SideToolsBar() {
                    ...
                    <div className="min-h-screen flex relative lg:static surface-ground">
                        <div id="app-sidebar-2" className="surface-section h-screen block flex-shrink-0 absolute lg:static left-0 top-0 z-1 border-right-1 surface-border select-none" style={{ width: '280px' }}>
                            <div className="flex flex-column h-full">
                                <div className="flex align-items-center justify-content-between px-4 pt-3 flex-shrink-0 flex-row">
                                    <span className="inline-flex align-items-center gap-2">
                                        <Logo />
                                        <span className="font-semibold text-2xl text-primary gradient-text">ScheduleMaster</span>
                                    </span>
                                    <span>
                                        <Button type="button" ref={closeIconRef as React.Ref<Button>} onClick={(e) => hide(e)} icon="pi pi-times" rounded outlined className="h-2rem w-2rem"></Button>
                                    </span>
                                </div>
